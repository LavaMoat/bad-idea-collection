...
/*
original source by @timiscoding
https://codepen.io/timiscoding/pen/RjgxoY?__cf_chl_captcha_tk__=17f0dc21067b7f58a31d86a608ff4b400f2e7a33-1585277498-0-AeD0eF2TwY9dTq-X4QJvL-Uj2OkqvGFRhBgf67Y6y3W2oyKtWkIHbTUqQN8EkfKl6IWlqd3TGI27TOswVTShHlxOJ2jfFH4w_GZhqmEGY6YBy91eTLdskCC3DBjvXMZlYVn3I9iv5DmNbM5GaldbJgAS45BOqq6fV9riHU71_ivrfdGS70xYx4InZp0eo4jqZ8zl1QYmJ_DUvRPIgXHevfxSZFgccrctknlYyJaqXvTcv58krqCslNf3ORej3vwF3k-7lNenmzXtUYF0VtUNfhhAZJfI48YWK96FbDG2m6MdPL4vfDIG9zdPzaFMVLGfbUFYr0B-l0cLaW10WgC5qtUFA2q6HV7iLeCSKLB9baSjtlcKTG6ff_zxflDAhIhe0xs2Q77seIwE0I1a1phrmAPSslN2bw649az7y7HFZnzVgxTaheLhBe_bci6Fs2M89A
*/

module.exports = makeItRain

function makeItRain (opts) {
  const scene = createScene(opts)
  return new p5(scene)
}

function createScene(opts = {}) {
  const sceneQuotes = opts.sceneQuotes || ['this is fine', 'oh no', 'halp']
  return (p) => {
  ...
  Symbols - Avg ${symbols.avg}  Max ${symbols.max} Min ${symbols.min}`);
    ...
    class Matrix {
      constructor({ isFullscreen } = {}) {
        ...
        this.db = new DebugMatrix({ isEnabled: false, matrix: this });
      }
